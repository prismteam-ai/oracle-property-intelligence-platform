...
CREATE TABLE "occupancies" (
	"occupancy_id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"tenant_id" uuid,
	"property_id" uuid,
	"address_id" uuid,
...
CREATE TABLE "project_contractors" (
	"project_contractor_id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE "project_permits" (
	"project_permit_id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"project_id" uuid NOT NULL,
	"property_improvement_id" uuid NOT NULL,
	"source_payload" jsonb DEFAULT '{}'::jsonb NOT NULL,
	"source_system" text NOT NULL,
...
CREATE TABLE "projects" (
	...
	"project_status" text,
	"project_type" text,
	"is_major_renovation" integer,
	"renovation_trades" text[] DEFAULT ARRAY[]::text[] NOT NULL,
...
CREATE TABLE "public_records" (
	"public_record_id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "property_signal_rollups" (
	"property_signal_rollup_id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"property_id" uuid,
	"parcel_id" uuid,
	"parcel_identifier" text,
	"municipality_name" text,
	"subdivision" text,
	"open_permit_count" integer DEFAULT 0 NOT NULL,
	"open_permit_categories" text[] DEFAULT ARRAY[]::text[] NOT NULL,
	"permit_count_5y" integer DEFAULT 0 NOT NULL,
	"major_renovation_count" integer DEFAULT 0 NOT NULL,
	"renovation_trades" text[] DEFAULT ARRAY[]::text[] NOT NULL,
	"improvement_score" numeric(10, 2) DEFAULT '0' NOT NULL,
	"ownership_change_count" integer DEFAULT 0 NOT NULL,
	"business_turnover_count" integer DEFAULT 0 NOT NULL,
	"total_permit_value" numeric(18, 2) DEFAULT '0' NOT NULL,
	"factor_payload" jsonb DEFAULT '{}'::jsonb NOT NULL,
	"source_payload" jsonb DEFAULT '{}'::jsonb NOT NULL,
	"source_system" text NOT NULL,
	"source_record_key" text NOT NULL,
...
CREATE TABLE "entity_documents" (
	...
	"source_systems" text[] DEFAULT ARRAY[]::text[] NOT NULL,
...
ALTER TABLE "occupancies" ADD CONSTRAINT "occupancies_tenant_id_tenants_tenant_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("tenant_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "occupancies" ADD CONSTRAINT "occupancies_property_id_properties_property_id_fk" FOREIGN KEY ("property_id") REFERENCES "public"."properties"("property_id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "occupancies" ADD CONSTRAINT "occupancies_address_id_addresses_address_id_fk" FOREIGN KEY ("address_id") REFERENCES "public"."addresses"("address_id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "occupancies" ADD CONSTRAINT "occupancies_business_registration_id_business_registrations_business_registration_id_fk" FOREIGN KEY ("business_registration_id") REFERENCES "public"."business_registrations"("business_registration_id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "occupancies" ADD CONSTRAINT "occupancies_company_id_companies_company_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("company_id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "tenants" ADD CONSTRAINT "tenants_person_id_people_person_id_fk" FOREIGN KEY ("person_id") REFERENCES "public"."people"("person_id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "tenants" ADD CONSTRAINT "tenants_company_id_companies_company_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("company_id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "project_contractors" ADD CONSTRAINT "project_contractors_project_id_projects_project_id_fk" FOREIGN KEY ("project_id") REFERENCES "public"."projects"("project_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "project_contractors" ADD CONSTRAINT "project_contractors_company_id_companies_company_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("company_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "project_permits" ADD CONSTRAINT "project_permits_project_id_projects_project_id_fk" FOREIGN KEY ("project_id") REFERENCES "public"."projects"("project_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "project_permits" ADD CONSTRAINT "project_permits_property_improvement_id_property_improvements_property_improvement_id_fk" FOREIGN KEY ("property_improvement_id") REFERENCES "public"."property_improvements"("property_improvement_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "projects" ADD CONSTRAINT "projects_property_id_properties_property_id_fk" FOREIGN KEY ("property_id") REFERENCES "public"."properties"("property_id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "projects" ADD CONSTRAINT "projects_parcel_id_parcels_parcel_id_fk" FOREIGN KEY ("parcel_id") REFERENCES "public"."parcels"("parcel_id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "property_signal_rollups" ADD CONSTRAINT "property_signal_rollups_property_id_properties_property_id_fk" FOREIGN KEY ("property_id") REFERENCES "public"."properties"("property_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "property_signal_rollups" ADD CONSTRAINT "property_signal_rollups_parcel_id_parcels_parcel_id_fk" FOREIGN KEY ("parcel_id") REFERENCES "public"."parcels"("parcel_id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "occupancies_tenant_idx" ON "occupancies" USING btree ("tenant_id");--> statement-breakpoint
CREATE INDEX "occupancies_property_idx" ON "occupancies" USING btree ("property_id");--> statement-breakpoint
CREATE INDEX "occupancies_address_idx" ON "occupancies" USING btree ("address_id");--> statement-breakpoint
CREATE INDEX "occupancies_business_registration_idx" ON "occupancies" USING btree ("business_registration_id");--> statement-breakpoint
CREATE INDEX "occupancies_company_idx" ON "occupancies" USING btree ("company_id");--> statement-breakpoint
CREATE INDEX "occupancies_status_idx" ON "occupancies" USING btree ("occupancy_status");--> statement-breakpoint
CREATE INDEX "occupancies_dates_idx" ON "occupancies" USING btree ("start_date","end_date");--> statement-breakpoint
CREATE UNIQUE INDEX "tenants_source_record_idx" ON "tenants" USING btree ("source_system","source_record_key");--> statement-breakpoint
CREATE INDEX "tenants_person_idx" ON "tenants" USING btree ("person_id");--> statement-breakpoint
CREATE INDEX "tenants_company_idx" ON "tenants" USING btree ("company_id");--> statement-breakpoint
CREATE INDEX "tenants_normalized_name_idx" ON "tenants" USING btree ("normalized_name");--> statement-breakpoint
CREATE UNIQUE INDEX "project_contractors_source_record_idx" ON "project_contractors" USING btree ("source_system","source_record_key");--> statement-breakpoint
CREATE UNIQUE INDEX "project_contractors_unique_idx" ON "project_contractors" USING btree ("project_id","company_id");--> statement-breakpoint
CREATE INDEX "project_contractors_company_idx" ON "project_contractors" USING btree ("company_id");--> statement-breakpoint
CREATE UNIQUE INDEX "project_permits_source_record_idx" ON "project_permits" USING btree ("source_system","source_record_key");--> statement-breakpoint
CREATE UNIQUE INDEX "project_permits_unique_idx" ON "project_permits" USING btree ("project_id","property_improvement_id");--> statement-breakpoint
CREATE INDEX "project_permits_permit_idx" ON "project_permits" USING btree ("property_improvement_id");--> statement-breakpoint
CREATE UNIQUE INDEX "projects_source_record_idx" ON "projects" USING btree ("source_system","source_record_key");--> statement-breakpoint
CREATE INDEX "projects_property_idx" ON "projects" USING btree ("property_id");--> statement-breakpoint
CREATE INDEX "projects_parcel_idx" ON "projects" USING btree ("parcel_id");--> statement-breakpoint
CREATE INDEX "projects_status_idx" ON "projects" USING btree ("project_status");--> statement-breakpoint
CREATE INDEX "projects_major_idx" ON "projects" USING btree ("is_major_renovation");--> statement-breakpoint
CREATE UNIQUE INDEX "public_records_source_record_idx" ON "public_records" USING btree ("source_system","source_record_key");--> statement-breakpoint
CREATE INDEX "public_records_entity_idx" ON "public_records" USING btree ("entity_type","entity_id");--> statement-breakpoint
CREATE INDEX "public_records_source_system_idx" ON "public_records" USING btree ("source_system");--> statement-breakpoint
CREATE INDEX "public_records_collection_ts_idx" ON "public_records" USING btree ("collection_timestamp");--> statement-breakpoint
CREATE UNIQUE INDEX "property_signal_rollups_source_record_idx" ON "property_signal_rollups" USING btree ("source_system","source_record_key");--> statement-breakpoint
CREATE UNIQUE INDEX "property_signal_rollups_property_idx" ON "property_signal_rollups" USING btree ("property_id");--> statement-breakpoint
CREATE INDEX "property_signal_rollups_open_permit_idx" ON "property_signal_rollups" USING btree ("open_permit_count");--> statement-breakpoint
CREATE INDEX "property_signal_rollups_permit5y_idx" ON "property_signal_rollups" USING btree ("permit_count_5y");--> statement-breakpoint
CREATE INDEX "property_signal_rollups_major_idx" ON "property_signal_rollups" USING btree ("major_renovation_count");--> statement-breakpoint
CREATE INDEX "property_signal_rollups_score_idx" ON "property_signal_rollups" USING btree ("improvement_score");--> statement-breakpoint
CREATE INDEX "property_signal_rollups_municipality_idx" ON "property_signal_rollups" USING btree ("municipality_name");--> statement-breakpoint
CREATE UNIQUE INDEX "entity_documents_source_record_idx" ON "entity_documents" USING btree ("source_system","source_record_key");--> statement-breakpoint
CREATE INDEX "entity_documents_entity_idx" ON "entity_documents" USING btree ("entity_type","entity_id");--> statement-breakpoint
CREATE INDEX "entity_documents_corpus_type_idx" ON "entity_documents" USING btree ("corpus_type");--> statement-breakpoint
CREATE INDEX "entity_documents_fts_idx" ON "entity_documents" USING gin (to_tsvector('english', coalesce("title", '') || ' ' || coalesce("body", '')));--> statement-breakpoint
CREATE INDEX "entity_documents_embedding_hnsw_idx" ON "entity_documents" USING hnsw ("embedding" vector_cosine_ops);--> statement-breakpoint
...
CREATE VIEW "public"."contractor_profile_view" AS (
  select
    "companies"."company_id" as company_id,
    "companies"."name" as name,
    "companies"."normalized_name" as normalized_name,
    "business_reputation_profiles"."business_reputation_profile_id" as business_reputation_profile_id,
    "business_reputation_profiles"."bbb_rating" as bbb_rating,
    "business_reputation_profiles"."rating_score" as rating_score,
    "business_reputation_profiles"."review_average_rating" as review_average_rating,
    "business_reputation_profiles"."review_count" as review_count,
    "business_reputation_profiles"."complaint_count" as complaint_count,
    "contractor_quality_scores"."score" as quality_score,
    "contractor_quality_scores"."score_band" as score_band
  from "companies"
  left join "business_reputation_profiles"
    on "business_reputation_profiles"."company_id" = "companies"."company_id"
  left join "contractor_quality_scores"
    on "contractor_quality_scores"."company_id" = "companies"."company_id"
);--> statement-breakpoint
CREATE VIEW "public"."project_view" AS (
  select
    "projects"."project_id" as project_id,
    "projects"."property_id" as property_id,
    "projects"."parcel_id" as parcel_id,
    "projects"."project_name" as project_name,
    "projects"."project_status" as project_status,
    "projects"."project_type" as project_type,
    "projects"."is_major_renovation" as is_major_renovation,
    "projects"."permit_count" as permit_count,
    "projects"."total_estimated_value" as total_estimated_value,
    "projects"."completion_date" as completion_date
  from "projects"
);--> statement-breakpoint
CREATE VIEW "public"."property_signal_view" AS (
  select
    "property_signal_rollups"."property_id" as property_id,
    "property_signal_rollups"."parcel_identifier" as parcel_identifier,
    "property_signal_rollups"."municipality_name" as municipality_name,
    "property_signal_rollups"."subdivision" as subdivision,
    "property_signal_rollups"."open_permit_count" as open_permit_count,
    "property_signal_rollups"."permit_count_5y" as permit_count_5y,
    "property_signal_rollups"."major_renovation_count" as major_renovation_count,
    "property_signal_rollups"."improvement_score" as improvement_score,
    "property_signal_rollups"."ownership_change_count" as ownership_change_count,
    "property_signal_rollups"."business_turnover_count" as business_turnover_count
...
CREATE VIEW "public"."tenant_profile_view" AS (
  select
    ...
    "tenants"."normalized_name" as normalized_name,
    "tenants"."tenant_type" as tenant_type,
    "tenants"."person_id" as person_id,
    "tenants"."company_id" as company_id
  from "tenants"
);